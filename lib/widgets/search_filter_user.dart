...
class SearchFilterUser extends StatelessWidget {
      ...
      onTap: isEnabled
          ? () {
              if (isDatePicker) {
                ...
                _showFilterDialog(context, label, fieldKey!);
              }
            }
          : null,
      child: Container(
  ...
  void _showFilterDialog(BuildContext context, String label, String fieldKey) {
